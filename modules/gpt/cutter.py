...
1. [Cut 1~2] Hook (호기심 유발): 3초 만에 시청자의 스크롤을 멈춰야 합니다. 질문에 대한 가장 충격적이거나 궁금증을 유발하는 파격적인 한마디로 시작하세요. (예: "블랙홀에 사람이 빠지면 어떻게 될까요? 결말은 끔찍합니다.")
2. [Cut 3~4] Context (배경 설명 및 스케일 업): Hook에서 던진 질문에 원리나 배경을 짧게 덧붙여 몰입감을 극대화합니다.
3. [Cut 5~7] Climax (결정적 해답 및 반전): 시청자가 가장 기다려온 '정답'이나 '반전'을 터뜨립니다. 지루한 설명은 빼고 팩트(Fact) 기반의 직관적인 비유로 결과를 명확히 제시하세요. (거짓 정보 절대 금지)
4. [전체 6~10컷 중 마지막 컷들] Conclusion & CTA (결론 및 마무리): 결과를 짧게 요약하거나 재치 있는 멘트("구독하고 우주 상식 알아가세요!")로 깔끔하게 떨어지게 마무리합니다.
