...
포맷 판단 기준:
- [포맷:WHO_WINS]: 두 대상 비교가 자연스러운 주제
  → 신호: "vs", "더 강한", "누가", "이길까", 두 개체 대결 구도
  → 예: "태양 vs 블랙홀", "공룡 vs 현대 탱크", "번개 vs 화산"
  → 주간 21개 중 5-7개 목표

- [포맷:IF]: 가정/시나리오가 자연스러운 주제
  → 신호: "만약", "사라진다면", "없어지면", "갑자기", "하루아침에"
  → 예: "달이 사라진다면", "중력이 없어지면", "지구가 멈추면"
  → 주간 21개 중 4-5개 목표

- [포맷:EMOTIONAL_SCI]: 신체/심리/감성 팩트 주제
  → 신호: 인체, 감정, 기억, 관계, 따뜻한 과학
  → 예: "엄마 몸속 아이 세포", "눈물의 성분", "피부가 기억하는 것"
  → 주간 21개 중 2-3개 목표 (KO/ES 채널 강세)

- [포맷:FACT]: 나머지 모든 팩트/우주/자연/역사 주제
  → 기본값 — 위 3가지에 해당 안 되면 FACT
  → 주간 21개 중 6-9개

포맷 태그 표기:
- 반드시 [공통] 태그 뒤에 [포맷:XXX] 함께 표기
- 하루 3개 중 WHO_WINS 최대 1개 권장 (2개 연속 금지)
...
- 모든 주제에 [포맷:XXX] 태그 필수 — 주제 성격 보고 자동 판단
- WHO_WINS: 자연스러운 대결 구도 주제만, 억지 비교 금지
- WHO_WINS는 하루 최대 1개 (2개 연속 배치 금지)
- EMOTIONAL_SCI: 신체/심리/감성 주제만 (우주/자연 팩트에 강제 적용 금지)
- 히트 패턴 복제 토픽: 주당 3-4개
