...
def _build_format_slate_rules(days: int) -> str:
  ...
  권장 주간 배분: WHO_WINS 최대 1-2개, IF 3-4개, PARADOX 3-4개, FACT 4-5개,
  COUNTDOWN 0개(임시 중단), SCALE 2개, MYSTERY 2-3개, EMOTIONAL_SCI 2개.
  WHO_WINS는 askanything용 concrete duel이 정말 강할 때만 편성하고,
  ...
  WHO_WINS는 구체 종명/대상명이 모두 있고 승부축이 분명할 때만 예외적으로 허용한다.
  ...
  WHO_WINS는 전체 기간 동안 최대 1개까지만 사용하고, askanything 쪽 클릭 이유가 명확할 때만 채택한다.
...
- WHO_WINS는 concrete duel이 정말 강하고 승부축이 명확할 때만 사용한다. wonderdrop/exploratodo/prismtale는 기본적으로 FACT/PARADOX/MYSTERY/IF를 우선한다.
...
- [포맷:WHO_WINS]: 두 대상 비교가 자연스러운 주제 (11컷 대결)
  ...
  → ⚠️ wonderdrop/exploratodo/prismtale에서는 기본 비추천. askanything에서만 선택 우선권이 있고, EN/ES 채널은 concrete duel이어도 주간 최대 1개만 허용.
...
### wonderdrop (en)
Source Topic: English generation anchor (required for Topic 3 when tagged [채널분화], optional otherwise)
Title: English title
Description: 2-3 sentences plain text (NO hashtags, include search keywords naturally)
Hashtags: #Tag1 #Tag2 #Tag3 #Tag4 #Tag5

### exploratodo (es-LATAM)
Tema Base: ancla generativa en español (obligatorio en Topic 3 con [채널분화], opcional en otros)
Titulo: Titulo en español
Descripcion: 2-3 oraciones texto puro (SIN hashtags, incluir palabras clave)
Hashtags: #Tag1 #Tag2 #Tag3 #Tag4 #Tag5

### prismtale (es-US)
Tema Base: ancla generativa en español US (obligatorio en Topic 3 con [채널분화], opcional en otros)
